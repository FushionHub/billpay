...
export async function POST(req: Request) {
    try {
        ...
        const afxResponse = await createAfxVirtualAccount(userData.afx_customer_id, currency || 'USD');

        // Save the generated virtual account ID into our Supabase `accounts` table
